...
export default class Language {
    ...
    private static syntax = {
        keywords: ["agent", "const", "variable", "dynamic"],
        condition: ["if", "then", "else"],
        function: ["width", "height", "min", "max", "agents", "empty", "pi", "prob", "count", "filter", "step", "random", "choice", "sqrt", "abs", "floor", "ceil", "round", "sin", "cos", "tan"],
        booleans: ["true", "false"],
        logical: ["and", "or"],
    };
